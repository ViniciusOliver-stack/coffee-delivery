        ...
        <div className="flex justify-between gap-8 mt-[72px]">
                ...
                <div className="bg-base-card rounded-md p-10 mt-4">
                    <div>
                        ...
                        <form className="mt-8 flex flex-col gap-4">
                            <Input type="text" placeholder="Cep" className="placeholder:uppercase w-[200px]"/>
            ...
            <div className="w-[600px]">
                ...
                <div className="bg-base-card rounded-tl-md rounded-tr-[36px] rounded-br-md rounded-bl-[36px] p-10 mt-4">
                    <div>
                        <div className="flex justify-between">
                            ...
                            <div className="flex items-center justify-between gap-5">
                                <img src="https://i.imgur.com/GesgK2k.png" alt="" className="w-16 h-16"/>
                                <div>
                            ...
                            <p className="font-extrabold text-base-text">R$ <span>9,90</span></p>
                        </div>
                    </div>
                    ...
                    <div className="flex items-center justify-between text-base-text mb-4">
                        <p>Entrega</p>
                        <p>R$ <span>3,90</span></p>
                    </div>

                    <div className="flex items-center justify-between text-base-text font-bold text-xl mb-4">
                        <p>Total</p>
                        <p>R$ <span>39,90</span></p>
                    </div>
                    </div>

                    <div className="relative">
                        <button className="w-full px-2 py-3 bg-yellow rounded-md text-white uppercase font-bold mt-6 ">Confirmar pedido</button>
